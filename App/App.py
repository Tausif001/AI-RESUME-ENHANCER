...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/Tausif001" style="text-decoration: none; color: #021659;">Tausif Alam</a></b>' 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@123':
                ...
                st.success("Welcome Tausif! Total %d " % values + " User's Have Used Our Tool : )")                
